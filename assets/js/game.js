...
var fight = function(enemy) {
    ...
    // keep track of you goes first
    var isPlayerTurn = true;
    // makes false 50% of time
    if (Math.random() > 0.5) {
        isPlayerTurn = false;
    }
...
var endGame = function () {
    ...
    // check localStorage for high score, if it not there, use 0
    var highScore = localStorage.getItem("highscore");
    if (highScore === null) {
        highScore = 0;
    }

    // if player hove more money than the high score, player has new high score
